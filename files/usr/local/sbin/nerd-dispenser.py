...
from nclock import Settings, LedControllerThread, PumpControllerThread, SensorsControllerThread, TankController, RestartController
...
def init(parser):
    ...
    settings.restartController = RestartController.RestartController(settings)
