...
class HCSR04(Thread):
    ...
    def run(self):
        ...
        while self._run:
            ...
            if (state == "off" or state == "first") and (distance < self._threshold):
