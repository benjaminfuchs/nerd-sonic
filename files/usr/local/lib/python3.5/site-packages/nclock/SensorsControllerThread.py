...
class SensorsControllerThread(Thread):
    ...
    def __init__(self, settings):
        ...
        self._button.add_listener(self._update_status, "button.status")
        self._sensor.add_listener(self._update_status, "sensor.status")
    ...
    def _update_status(self, state, name):
        """ check button status """
