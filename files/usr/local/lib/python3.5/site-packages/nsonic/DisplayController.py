...
class DisplayController():
    ...
    def show_settings(self):
        ...
        self._draw_settings_string(1, "ip       : " + socket.gethostbyname(socket.gethostname()))
        with open('/proc/uptime', 'r') as f:
            uptime_seconds = float(f.readline().split()[0])
        self._draw_settings_string(2, "uptime[h]: " + str(round(uptime_seconds/60/60, 2)))
        self._draw()
    ...
    def _draw_settings_menu(self):
        self._draw_menu_rectangle(1, None)
    ...
    def _draw_settings_string(self, num, text):
        ...
        self._epd.draw_string_at(self._frame_black, block_size +
                                 20, 20 * num + block_size + 5, text, font_subtext, COLORED)
