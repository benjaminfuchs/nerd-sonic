...
class DisplayController():
    ...
    def __init__(self, settings):
        ...
        self._settings.add_settings_listener(
            'sensors.tank.value', self.update_sensor_values)

    def update(self):
        self._draw()

    # pylint: disable=unused-argument
    def update_sensor_values(self, name, old, new):
        self._clear()
    ...
    def show_main_menu(self):
        self.update_sensor_values(None, None, None)
    ...
    def _draw_main_string(self, num, text, subtext):
        ...
        font_text = ImageFont.truetype(
            '/usr/share/fonts/truetype/lato/Lato-Bold.ttf', 40)
        font_subtext = ImageFont.truetype(
            '/usr/share/fonts/truetype/lato/Lato-Light.ttf', 20)
    ...
    def _draw_menu_string(self, num, label, active):
        ...
        font_size = 28
        font = ImageFont.truetype(
            '/usr/share/fonts/truetype/lato/Lato-Bold.ttf', font_size)
        if active == num:
